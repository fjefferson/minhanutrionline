...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Os efeitos colaterais costumam ser leves e passageiros, sendo mais comuns problemas gastrointestinais como náusea e diarreia, especialmente no início do tratamento. Cada organismo reage de um jeito. Nossa nutricionista está disponível para orientar como minimizar o desconforto.",
  },
  {
  ...
  },
  {
    ...
    a: "A ANVISA exige prescrição médica em duas vias (uma retida pela farmácia), com validade de 90 dias. A compra e venda devem ser registradas no Sistema Nacional de Gerenciamento de Produtos Controlados (SNGPC). Nunca adquira esses medicamentos sem prescrição.",
  },
  {
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8">
            {[
              ...
              },
              {
                ...
                step: "4",
                title: "Consulta online — Premium",
                desc: "No plano Premium, agende consultas individuais por videochamada com a nutricionista.",
                badge: "Premium",
              },
            ].map((item) => (
              <div
              ...
              >
                {"badge" in item && (
                  <span className="absolute top-4 right-4 text-xs font-semibold bg-green-600 text-white px-2 py-0.5 rounded-full">
                    {item.badge}
                  </span>
                )}
